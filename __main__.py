...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="steela_"),
        InlineKeyboardButton(
    ...
    if query.data == "steela_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Anjal*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Anjal's licensed under the GNU General Public License v3.0_
                 \n❍ Awesome Bots @NobisukiSupport
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Anjal*
                 \nHere is the [Source Code](https://github.com/Godofanjal/AnjalRobot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID !=1891633746 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@NobisukiSupport", "Yes I'm alive 😹")
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(layla_about_callback, pattern=r"steela_")
